...
<table width="100%" align="center">
  <tr height="40px">
     <td align="center" colspan="2" class="formHeading" bgcolor="#F5F6CE">Online Leave Management System</td>
  </tr>
  <tr height="40px">
     <td align="center" colspan="2" class="formHeading" bgcolor="#F5F6CE">Leave Entry Form</td>
  </tr>  
  <tr height="10px">
     <td colspan="2"></td>
  </tr>
 </table>
<form id="frm1" name=F1 enctype="multipart/form-data" action="FileulServlet?userid=<%=request.getAttribute("Message")%>" method="post">
...
<table width="100%" align="center">
  <tr align="center">
    ...
    Logged in user: Emp Code- <%=request.getAttribute("Message")%>,Emp Name- <%=request.getAttribute("Message1")%>
  </td>
</tr>
</table>
                    ...
                    <label> Type Leave :</label><select required name="type_leave">
                       <option value=" ">  </option>
                       ...
                       <option value="SCL">SCL</option>                                       
                         ...
                         <label> From:</label><input type="text" size="12" name="date1" id="date1"></input> 
                         <label> To  :</label><input type="text" size="12" name="date2" id="date2"></input>
                         <label> No of Days :</label> <input type="text" size="3" maxlength="3" name="no_days"/>
                         <label> If Half CL :</label> <select required name="half_cl">
                               <option value=" ">  </option>
                               <option value="F/N">F/N</option>
                               <option value="A/N">A/N</option></select> <br></br>   
                 <!--          <label> A/B Shift Days :</label> <input type="text" size="2" maxlength="2" name="abshift" value="0"/>
                          <label> C Shift Days :</label> <input type="text" size="2" maxlength="2" name="cshift" value="0"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --> 
                          <label> Remarks :</label> <input type="text" size="35" maxlength="35" name="remarks" value=" "/>                                               
                     </form>
                    </body>  
                   </td>                                      
                   </tr>                   
             <!--       <tr>
                     <td width="50%" align="center">
                          <label> A/B Shift Days :</label> <input type="text" size="2" maxlength="2" name="abshift"/>
                          <label> C Shift Days :</label> <input type="text" size="2" maxlength="2" name="cshift"/>
                          <label> Remarks :</label> <input type="text" size="35" maxlength="35" name="remarks"/>
                     </td>
                   </tr>     -->               
                </table>                               
