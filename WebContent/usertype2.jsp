...
<td align="center">
 <ul>    
    <a href="sendtoleavestatusServlet?userid=<%=request.getAttribute("Message")%>"><b>Leave Application Status</b></a>    
 </ul>
 </td>
 <td align="center">
 <ul>
    <a href="sendtocostatusServlet?userid=<%=request.getAttribute("Message")%>"><b>View CO Details</b></a>    
 </ul>
 </td>
</tr>
</table>
...
<tr>
  <td align="center">
 <ul>
    <a href="sendtoleaveauthoServlet?userid=<%=request.getAttribute("Message")%>"><h2>Leave Authorization</h2></a>    
 </ul>
 </td>
</tr>
</table>
