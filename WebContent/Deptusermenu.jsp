...
<table width="100%" align="center">
   <tr align="center">
      <td width="90%" valign="middle" align="center" bgcolor=#ADD8E6 >
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2>Time Office (User Section) </h2>
      </td>
  ...
  <tr align="center">
    ...
    Logged in user department code- <%=request.getAttribute("Message")%>    
  </td>
</tr>
</table>
...
<td align="center">
<ul>      
      <a href="sendtodwleaveServlet?dept=<%=request.getAttribute("Message")%>"><b>View All Application</b></a>    
</ul>
</td>
<td align="center">
 <ul>    
    <a href="sendtoleavenotappServlet?dept=<%=request.getAttribute("Message")%>"><b>View Leave Not Applied List</b></a>    
 </ul>
 </td>
 <td align="center">
 <ul>    
    <a href="sendtoshiftupdServlet?dept=<%=request.getAttribute("Message")%>"><b>Shift Days Update</b></a>    
 </ul>
 </td>
<td>
<td>
 <ul>
    <a href="http:\\10.1.1.128:8080\TOReports\Leavedetails-viewer.jsp"><b>Print Leave Details</b></a>          
 </ul>      
</td>  
</tr>
</table>
